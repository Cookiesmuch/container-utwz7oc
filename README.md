...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-utwz7oc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-utwz7oc.containers.anotherwebservice.com/
...
```
git clone git@github.com:Cookiesmuch/container-utwz7oc.git
cd container-utwz7oc
```
...
```
docker attach container-utwz7oc
```
